...
class SiteController extends Controller
{
    ...
    {
        $model = Tentang::find()->all();
        $modelJenis = Jenis::find()->all();
        $modelProduk = Produk::find()->all();
        $modelBunga = TestyBunga::find()->all();
        $modelSnack = TestySnack::find()->all();
        $modelUang = TestyUang::find()->all();
    
        return $this->render('index', [
            'model' => $model,
            'modelJenis' => $modelJenis,
            'modelProduk' => $modelProduk,
            'modelTestyBunga' => $modelBunga,
            'modelTestySnack' => $modelSnack,
            'modelTestyUang' => $modelUang,
